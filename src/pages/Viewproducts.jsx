              ...
              <table className="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="">Face Wash</td>
                    <td className="">
                      <span
                        onClick={setshowProductImgModal}
            ...
            <div className="row">
              ...
              <div className="col-7 d-flex flex-column gap-3">
                <div className="d-flex gap-3">
                  <input
                    type="text"
                    id="edit_prduct_categroy"
                    placeholder="Category Name"
                    className="edit_product_input"
                  />
                  <label htmlFor="edit_prduct_categroy">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
              ...
              <div className="text-center mt-4">
                <button className="edit_product_modal_btn">Save Details</button>
              </div>
            </div>
          </Modal.Body>
        </Modal>
